...
<head>
<meta charset="utf-8">
<title>Stella Orr'e - Interior and Home Renovation HTML Template | Home Page 03</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
    ...
    <!-- Banner Section -->
	<section class="banner-section" style="background-image:url(images/background/3.jpg)">
						...
						<div class="form-box">
							...
							<div class="default-form">
								<form method="post" action="templateshub.net">
									...
									<div class="form-group">
										<button type="submit" class="theme-btn submit-btn">Book Free Consultation</button>
									</div>
				...
				<div class="content-column col-lg-8 col-md-12 col-sm-12">
					<div class="inner-column">
						...
						<div class="content">
							...
							<div class="text">Find design ideas from our design gallery or book a <br> meeting with a dedicated design expert</div>
						</div>
	...
	<section class="services-section-three">
		<div class="auto-container">
			...
			<div class="row clearfix">
				...
				<!-- Service Block -->
				<div class="service-block-three style-two col-lg-3 col-md-6 col-sm-12">
    ...
    <section class="fluid-section-one style-two">
    	<div class="outer-container clearfix">
			...
			<!--Image Column-->
        	<div class="image-column wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms" style="background-image: url(images/resource/video-img.jpg)">
				<div class="inner-column">
					<div class="image">
	...
	<!-- Interior Section -->
	<section class="interior-section style-two">
		<div class="auto-container">
			<div class="inner-container">
				<div class="row clearfix">
